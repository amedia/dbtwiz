    ...
    if selected_choice == {}:
        ...
        if project:
            ...
            if exists_check != "Exists":
                ...
                if action == "retry":
                    return ask_for_source()  # Retry source selection
                elif action == "manual":
                    project = ""  # Enter manual mode
...
def generate_source():
    ...
    manual_mode = not source["project"]
...
def create_source_file(source, table_name, description, columns=None):
