...
def warn(message: str):
    """Log a warning"""
    log_console.print(Panel(message, title="[bold yellow]Warning[/]", border_style="yellow", title_align="left"))

def error(message: str):
    """Log an error message"""
    error_console.print(Panel(message, title="[bold red]Error[/]", border_style="red", title_align="left"))
